...
<img src="img/pr1.jpg" width="280" height="580"><br/>  
	 ...
	 <div class="login" style="background-color:#bdb76b;">
		 ...
		 <form  action="labhistory.php" method="POST">
		 
<table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
               <tr><td><pre><font color="red">*</font><label>Enter/select Date:</label></pre></td><td>
				<?php 
													$res=mysql_query("select*from labresult l,account a where l.ACC_ID=a.ACC_ID AND a.ACC_ID='$acid'");
    ...
    <td> <input type="submit" id="button" class="button" name="searchlab" value="view Result" style="width:100%;height:40px;color:red;text-transform:capitalize;Font-weight:bolder;font-size:20px;border-top:6px;color:#0f0f0f;background:#5d8aa8;title:Enter the patient MRN;" /><td><a href = 'labtech.php?key='><font style='color:black;font-size:26px;float:right;border-radius:10px;margin-right:-200px;height:40px;background:#778899;margin-top:-37px;width:90px;'>Cancel</font></a></td>  		          
	</td>
    <td> <input type="submit" id="button" class="button" name="viewdetaillab" value="view Detail" style="width:127%;height:40px;color:red;text-transform:capitalize;Font-weight:bolder;font-size:20px;border-top:6px;color:#0f0f0f;margin-left:-35px;background:#5d8aa8;title:Enter the patient MRN;" /><td><a href = 'labtech.php?key='> 		          
	</td>
	</tr>	
 </form></table>
 <?php
   ...
   {
   // l,account a 
     $sql=mysql_query("select*from labresult l,account a where l.ACC_ID=a.ACC_ID AND a.ACC_ID='$acid' AND TreatmentDate='$_POST[Client_ID]'");
...
<tr>
<th colspan='1000000'style= 'font-size:26px; background:silver;color:green;'>Lab Result Information history<a href = 'labhistory.php?key='><font style='color:red;font-weight:30px;float:right;background:;font-size:20px;width;'>X</font></a></th></tr>
<tr>
<th>CardNumber</th>
<th>ACC_ID</th>
 ...
 $acid=$row['ACC_ID'];	   
  ...
  $dat=$row['TreatmentDate'];	 
	...
	echo "<img src='IMG/error.png' height='8%' align='bottom'><font type='Verdana' size='4' color='red'>Please enter the patient_id!!</font>";
	 echo' <meta content="10;labhistory.php" http-equiv="refresh" />'; 
	}
...
echo' <meta content="50;labhistory.php" http-equiv="refresh" />'; 
	echo "</table>";
	 }
	else
	{
...
<tr>
<th colspan='1000000'style= 'font-size:26px; background:silver;color:green;'> All Lab Result Informations <a href = 'labhistory.php?key='><font style='color:red;font-weight:30px;float:right;background:;font-size:20px;width;'>X</font></a></th></tr>
<tr><th>CardNumber</th>
<th>ACC_ID  </th>
<th>TreatmentResult </th>
<th>TreatmentDate </th>
...
// l,account a WHERE l.CardNumber= a.ACC_ID AND a.ACC_ID='$acid'
   $sqls="select*from labresult l,account a where l.ACC_ID=a.ACC_ID AND a.ACC_ID='$acid'";
