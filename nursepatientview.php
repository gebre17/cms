...
<img src="img/pr1.jpg" width="280" height="580"><br/>  
	 ...
	 <div class="login" style="background-color:#bdb76b;">
		 ...
		 <form  action="nursepatientview.php" method="POST">
...
<table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
    ...
    <td> <input type="submit" id="button" class="button" name="search" value="view Result" style="width:180%;height:40px;color:red;text-transform:capitalize;Font-weight:bolder;font-size:20px;border-top:6px;color:#0f0f0f;background:#5d8aa8;title:Enter the patient MRN;" /><td><a href = 'nurse.php?key='><font style='color:red;font-size:40px;float:right;border-radius:10px;margin-right:-125px;height:50px;background:#778899;margin-top:-30px;width;'>X</font></a></td> 		            		          
	</td></tr>	
...
<th>status</th>
<th>Action</th>
<th align = 'center' width = '1'><a href ='nursepatientview.php?key='><font style='color:red;font-weight:40px;float:right;margin-top:-2px;background:;border-radius:1px;height:;width:80px;font-size:60px;'>X</font></a></td></tr>";
