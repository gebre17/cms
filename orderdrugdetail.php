...
<h1 style="font-family:Lucida Calligraphy;"> k klinic  Management system</h1>
</div>
<div id="headerz">
...
<?php
$ctrl = $_REQUEST['key']; 
$query="SELECT * FROM orderdrug where Client_ID='{$ctrl}'";
...
?>
 <form method="POST" action="orderdrugdetail.php">
  <br><br>
 <table valign='top' align="center" style="width:300px;height:370px;border-radius:16px;border:2px solid blue;background-color:cyan;">
<tr>
<td></td>
<td align="right"><a href="viewdrugorder.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
...
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Prescrived by:</b></td><td><?php echo $row5?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Drug name:</b></td><td><?php echo $row6?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Amount:</b></td><td><?php echo $row7?></td>
</tr>
