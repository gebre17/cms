...
function handleSearchSuggest() {
	if (searchReq.readyState == 4) {
		...
		if(str.length==1)
		    ...
		    ss.setAttribute('style','position:absolute;top:'+curTop+';left:'+curLeft+';width:auto;z-index:1;padding:5px;border: 1px solid #000000; overflow:auto; height:auto; background-color:#F5F5FF; width:260px;');
		ss.innerHTML = '';
